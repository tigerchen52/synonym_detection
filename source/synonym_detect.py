...
parser.add_argument('-process_number', help='set the number of process, default is 30', type=int, default=2)
...
parser.add_argument('-if_use_leven_model', help='use Levenshtein model , default is true', type=bool, default=True)
parser.add_argument('-if_use_baike_crawler', help='use baike crawler, this model need to connect to the network, default is true', type=bool, default=False)
parser.add_argument('-if_use_w2v_model', help='use word2vector model , default is true', type=bool, default=False)
